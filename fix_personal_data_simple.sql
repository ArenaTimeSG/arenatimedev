...
-- Primeiro verificar estrutura real da tabela user_profiles
...
-- 6. Verificar se há perfil na tabela user_profiles (apenas colunas básicas)
SELECT 
    id,
    user_id,
    name,
...
-- 7. Se não houver perfil, criar um (apenas com colunas básicas)
