-- Script para verificar por que os agendamentos não aparecem no painel do cliente
...
-- 5. Verificar se há agendamentos online recentes
SELECT 
    a.*,
    bc.name as client_name,
    bc.email as client_email
...
-- 6. Verificar se há agendamentos com email PEDROGREEF06@GMAIL.COM
SELECT 
    a.*,
    bc.name as client_name,
    bc.email as client_email
