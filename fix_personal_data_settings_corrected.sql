...
-- A tabela user_profiles não tem coluna email
...
-- 6. Verificar se há perfil na tabela user_profiles (sem coluna email)
SELECT 
    id,
    user_id,
    name,
...
-- 7. Se não houver perfil, criar um (sem coluna email)
