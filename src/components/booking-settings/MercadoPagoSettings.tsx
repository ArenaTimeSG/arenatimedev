...
const MercadoPagoSettings = ({
  ...
  const [webhook, setWebhook] = useState(webhookUrl || `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/notification-webhook`);
  ...
  useEffect(() => {
    ...
    setKey(publicKey);
    setWebhook(webhookUrl || `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/notification-webhook`);
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder={`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/notification-webhook`}
                className="border-gray-200 focus:border-blue-300"
              />
              <p className="text-sm text-gray-600">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-blue-700 space-y-1">
                    <li>• URL: <code className="bg-blue-100 px-1 rounded">{webhook || `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/notification-webhook`}</code></li>
